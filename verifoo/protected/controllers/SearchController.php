		...
		{	
			...
			{	$lat = $long = '';
				...
				echo '<h2 id="bsearchSpan" business-data="'.$model->id.'" business-name="'.$model->businessname.'">'.$model->businessname.'<div class="bStars">
						<div class="star" style="width:'.(22*round($model->reviewAve)).'px"></div>
					</div></h2>';
				echo '<div class="socialsites">';
				...
				echo '</div>
					<div class="cvbD">
							...
							<a href="'.Yii::app()->createUrl('business/photos', array('id' => $model->id)).'"><div id="business'.$model->id.'" business-data="'.$model->id.'" business-toggle="0" class="bCtrl bCtrl2">Photos</div></a>
							<a href="'.Yii::app()->createUrl('business/view', array('id' => $model->id, '#' => "reviews")).'"><div id="business'.$model->id.'" business-data="'.$model->id.'>" business-toggle="0" class="bCtrl bCtrl3">Reviews</div></a>
					</div>
