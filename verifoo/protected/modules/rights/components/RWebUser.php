...
class RWebUser extends CWebUser
{
	...
	*/
    ...
    public function isTeamLeaderUser() {
                return $this->getState('isTeamLeaderUser');  
    }   
	public function isSystemAdminUser() {
                return $this->getState('isSystemAdminUser');  
    }  
	public function isQualityAssuranceUser() {
                return $this->getState('isQualityAssuranceUser');  
    }  
