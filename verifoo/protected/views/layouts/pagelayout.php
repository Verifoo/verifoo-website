...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/pagelayout.css" />
...
<div id="topOfHeader">
		<div class="topHeaderWrapper">
				...
				'items'=>array(
					...
					array('label'=>'Messages', 'url'=>array('/messages/'), 'visible'=>!Yii::app()->user->isGuest),
...
<div class="pageLH">
	<div id="logo">
		<a href="<?php echo Yii::app()->getBaseUrl(true);?>"><img src="<?php echo Yii::app()->getBaseUrl(true).'/images/verifoo-circle.png' ?>"/></a>
...
<div class="pagelayout-container" id="page">
